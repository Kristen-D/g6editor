...
//  that.height = that.cNodes.find('img').height();//得到容器的高度
    that.width = that.cNodes.find('.imgw').width();
    that.height = that.cNodes.find('.imgw').height();

//  console.log(that.cNodes.find('imgw'));
//  console.log("width:"+that.width+",,,,height:"+that.height);
