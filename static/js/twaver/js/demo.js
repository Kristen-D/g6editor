...
demo.Util = {
  ...
  createNetworkToolbar: function (network, interaction) {
    ...
    demo.Util.addButton(toolbar, '放大', 'magnify', function () {
...
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });
    ...
    demo.Util.addButton(toolbar, '缩放重置', 'zoomReset', function () { network.zoomReset(); });
    demo.Util.addButton(toolbar, '缩放概述', 'zoomOverview', function () { network.zoomOverview(); });
    demo.Util.addInteractionComboBox(toolbar, network, interaction);
    demo.Util.addButton(toolbar, '导出图像', 'export', function () {
      var canvas;
    ...
    if (demo.Util.isFullScreenSupported()) {
      demo.Util.addButton(toolbar, '全屏', 'fullscreen', function () {
  ...
  createTreeToolbar: function (tree) {
    var toolbar = document.createElement('div');
    demo.Util.addButton(toolbar, 'Reset Order', '/static/js/twaver/images/toolbar/reset.png', function () { tree.setSortFunction(null); });
    demo.Util.addButton(toolbar, 'Ascend Order', '/static/js/twaver/images/toolbar/ascend.png', function () {
    ...
    demo.Util.addButton(toolbar, 'Descend Order', '/static/js/twaver/images/toolbar/descend.png', function () {
      tree.setSortFunction(function (d1, d2) {
        if (d1.getName() < d2.getName()) {
          return 1;
        } else if (d1.getName() == d2.getName()) {
    ...
    demo.Util.addButton(toolbar, 'Move Selection To Top', '/static/js/twaver/images/toolbar/top.png', function () { tree.getDataBox().moveSelectionToTop(); });
    demo.Util.addButton(toolbar, 'Move Selection Up', '/static/js/twaver/images/toolbar/up.png', function () { tree.getDataBox().moveSelectionUp(); });
    demo.Util.addButton(toolbar, 'Move Selection Down', '/static/js/twaver/images/toolbar/down.png', function () { tree.getDataBox().moveSelectionDown(); });
    demo.Util.addButton(toolbar, 'Move Selection To Bottom', '/static/js/twaver/images/toolbar/bottom.png', function () { tree.getDataBox().moveSelectionToBottom(); });
    demo.Util.addButton(toolbar, 'Expand', '/static/js/twaver/images/toolbar/expand.png', function () {
    ...
    demo.Util.addButton(toolbar, 'Collapse', '/static/js/twaver/images/toolbar/collapse.png', function () {
      if (tree.getSelectionModel().size() == 1) {
  ...
  addButton: function (div, name, src, callback) {
    ...
    if (src) {
      ...
      if (src.indexOf('/') < 0) {
        src = '/static/js/twaver/images/toolbar/' + src + '.png';
      }
  ...
  initPropertySheet: function (sheet) {
    ...
    demo.NodeImages = addNodeProperty('image', 'accessor', true);
    // demo.customAsset = addNodeProperty('assetID');
