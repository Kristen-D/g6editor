var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            sOut += '<dt>创建者</dt><dd>由 <a href="#">搜索</a> 创建</dd>';
            sOut += '<dt>应用</dt><dd>search</dd>';
            sOut += '<dt>计划</dt><dd>未计划。<a href="#">编辑</a></dd>';
            sOut += '<dt>加速</dt><dd>已禁用。</dd>';
			sOut += '<dt>权限</dt><dd>在应用中共享。由 nobody 拥有。<a href="#">编辑</a></dd>';
			sOut += '<dt>Embedding</dt><dd>已禁用。</dd>';
            sOut += '</dl>';
