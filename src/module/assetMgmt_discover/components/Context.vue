...
<div class="whitebackground Whitespace">
  <div class="top-title">资产发现列表</div>
  <div class="float-r" style="margin-top: -60px; margin-right: 20px;">
...
<script>
import editTable from './AssetDiscoverdEditTable.vue'
export default {
  components: {
    editTable,
  },
