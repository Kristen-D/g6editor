...
<div class="">
  <el-dialog :title="drillData.title" :visible.sync="drillData.dialogTableVisible" width="85%" class="dialog-panel">
    <el-table :data="drillData.tableData" style="margin-top:20px;">
      ...
      <el-table-column prop="account_stolen" label="操作用户" align="center" width="300" show-overflow-tooltip></el-table-column>
      <el-table-column prop="operation" label="操作类型" align="center" ></el-table-column>
      <el-table-column prop="trans_amount" label="操作金额" align="center"></el-table-column>
      <!-- <el-table-column prop="cvenumber" label="CVE编号" align="center"></el-table-column> -->
      <el-table-column prop="occ_time" label="操作时间" align="center"></el-table-column>
      <el-table-column prop="login_ip" label="操作IP" align="center" ></el-table-column>
