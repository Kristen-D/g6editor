<template>
<div class="echartsbox2" id="barbox9"></div>
</template>
...
export default {
  ...
  methods: {
    async getInitData() {
      this.common.req('/ssa/ebankpoc/getAccountStolenTop5.do', {}, this).then((data) => {
        // console.log(data);
    ...
    loadMapChart(data) {
      ...
      let myChart = echarts.init(document.getElementById('barbox9'));
      ...
      let option = {
        ...
        yAxis: [{
            type: 'category',
            data: datax,
            // ['10.23.10.191', '10.23.10.192', '10.23.10.193', '10.23.10.194', '10.23.10.195'],
            axisTick: {
              show: false
            },
            axisLine: {
      ...
      myChart.on('click', function(params) {
        ...
        let parameters = { account_stolen: params.name, title: '账号盗用详情' };
