<template>
<div class="echartsbox1" id="linebox3" style="height:350px;"></div>
</template>
...
export default {
  ...
  methods: {
    async getInitData() {
      this.common.req('/ssa/ebankpoc/getAccountStolenTrend.do', {}, this).then((data) => {
    ...
    loadMapChart(data) {
      ...
      let myChart = echarts.init(document.getElementById('linebox3'));
      let option = {
      ...
      myChart.on('click', function(params) {
        ...
        let parameters = { occ_time: params.name, title: '账号盗用详情' };
