<template>
<div class="echartsbox1" id="attackbox2"></div>
</template>
...
export default {
  ...
  methods: {
    async getInitData() {
      this.common.req('/ssa/ebankpoc/getRobotLoginSpread.do', {}, this).then((data) => {
    ...
    loadMapChart(data) {
      ...
      let myChart = echarts.init(document.getElementById('attackbox2'));
      var geoCoordMap = {
        ...
        '中国澳门': [113.5734, 22.1566],
        '中国台湾': [121.4753, 25.0708],
      ...
      let option = {
        tooltip: {
          ...
          formatter: function(params) {
            ...
            let sourceip = "55.55.132.12";
            let value = 30;
            res = "<div style='background:#2d3031;padding:10px;font-size:12;'><p>攻击源：" + name +
              "</p><p>源IP：" + sourceip +
              "</p><p>攻击数：" + value + "</p></div>";
            return res;
          }
        ...
        series: [{
            ...
            // formtGCData(geoCoordMap, data, '上海', false),
            tooltip: {
              show: false
            }
          }, {
            ...
            data: convertData(newData),
            // formtGCData(geoCoordMap, data2, '上海', false),
            tooltip: {
              show: false
            }
          }, {
            ...
            data: newData.map(function(dataItem) {
            ...
            // formtVData(geoCoordMap, data, '上海')
          },
          // {
          //
          //   type: 'effectScatter',
          ...
          //     };
          // })
          //   // formtVData(geoCoordMap, data2, '上海')
          // }
        ]
      };
