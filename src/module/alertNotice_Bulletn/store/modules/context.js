...
const actions = {
  ...
  async getNoticeHandleInfoById({
    ...
    var result = await common.req("/ssa/alertNoticeBulletn/getNoticeHandleInfoById.do", params, this);
    return result;
  },
  ...
  async getFeedbackDetail({
    ...
    var result = await common.req("/ssa/alertNoticeBulletn/getFeedBackByTaskId.do", params, this);
    return result;
  },
