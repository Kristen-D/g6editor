  ...
  <div class="container-fluid">
    <div class="el-panel">
      <div class="el-panel-heading">
        <h4 class="el-panel-title">面板自定义</h4>
      </div>
      <div class="el-panel-body p-0">

        <div class="search">
          <div class="ordinary-search" style="margin-bottom: -15px;">
            <el-form :inline="true" :model="queryForm" ref="queryForm">
              ...
              <el-form-item>
                <el-button @click="qry()" type="primary" size="small">查询</el-button>
              </el-form-item>
            </el-form>
          </div>
        </div>
        <div class="table-head-panel">
          <h3 class="">列表</h3>
          <div class="op-location2">
    ...
    methods: {
      ...
      delCheckedRows() {
        ...
        this.$confirm('此操作将删除选中行, 是否继续?', '提示', {
          ...
          var ids = idsArr.join(",");
          await vm.common.req("/ssa/viewPlugins/deleteGridPageByIds.do", {
            'ids': ids
          });
