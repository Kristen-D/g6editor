...
<div>
    ...
    <div class="whitebackground Whitespace">
      <div class="top-title" v-if="!this.$route.params.list_id">新增白名单</div>
      <div class="top-title" v-if="this.$route.params.list_id">编辑白名单</div>
...
export default {
  ...
  created: function() {
    this.commonAjax.req("/ssa/infoCenter_blackWhiteList/getLoginUserInfo.do", null, this).then(data => {
      this.loginUser = data;
      this.blackWhiteForm.org_id = this.loginUser.org_id;
      //alert(this.loginUser.org_id);
    });
