<template>
  <div class="el-panel-bigscreen">
   <div class="el-panel-bigscreen-heading">
     <h4 class="el-panel-bigscreen-subtitle2">攻击等级分布</h4>
   </div>
   <div class="el-panel-bigscreen-body">
      <div class="echartsbox6" id="attacklevelsort"></div>
   </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    loadMapChart() {
      let myChart = echarts.init(document.getElementById('attacklevelsort'));
    	let option = {
