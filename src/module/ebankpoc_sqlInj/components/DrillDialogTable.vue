...
<div class="">
  <el-dialog :title="drillData.title" :visible.sync="drillData.dialogTableVisible" width="85%" class="dialog-panel">
    <el-table :data="drillData.tableData" style="margin-top:20px;">
      ...
      <el-table-column prop="srcIp" label="源IP" align="center" width="300" ></el-table-column>
      <el-table-column prop="occ_time" label="发生时间" align="center" ></el-table-column>
      <el-table-column prop="method" label="请求方法" align="center"></el-table-column>
      <el-table-column prop="data" label="请求参数" align="center" show-overflow-tooltip></el-table-column>
      <el-table-column prop="url" label="请求URL" align="center" show-overflow-tooltip></el-table-column>
      <el-table-column prop="srcType" label="扫描时间" align="center" sortable></el-table-column>
      <el-table-column prop="reserved" label="注入详细信息" align="center" sortable></el-table-column>
      </el-table-column>
      <div slot="empty" >
