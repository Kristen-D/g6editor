        ...
        <el-row>
            ...
            <template  v-for="(merge_relation,index) in formRule.merge_relations">
              <el-row>
                <el-col :span="10" :offset="1">
                    <el-form-item v-bind:label="'属性'+(index+1)+':'" :prop="'merge_relations.'+index+'.attrName'" :rules="{required: true, message: '事件属性不能为空', trigger: 'change'}">
                        <el-select v-model="merge_relation.attrName">
                ...
                <el-col :span="2" >
                    <label class="delet font-color m-l-30" @click="delAttrRule(index)"><i class="el-icon-delete2 m-r-8"></i>删除</label>
            ...
            <el-row>
                <el-col :span="3" :offset="2" >
                    <label class="add font-color"  @click="addAttr">添加属性</label>
