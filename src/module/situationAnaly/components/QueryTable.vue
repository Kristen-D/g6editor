...
<el-dialog title="事件详情" :visible.sync="myShow" width="85%" @close="onCloseIp()" class="dialog-panel" top="5%">
  <!-- <div style="height:300px"> -->
    <dataDetail :tableData="rowData"></dataDetail>
  <!-- </div> -->
</el-dialog>

<el-dialog title="攻击溯源" :visible.sync="myPicShow" width="85%" @close="onCloseIp()" class="dialog-panel" top="5%">
    <showPic :rowData="rowData"></showPic>
</el-dialog>
</div>
</template>
