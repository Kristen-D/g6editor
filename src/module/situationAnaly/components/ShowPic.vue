...
<div class="whitebackground Whitespace">
  ...
  <div class="attack-sel clearfloat">
    <el-row>
        <el-col :span="25">
          <span class="demonstration">{{this.rowdata.event_msg}}</span>
        </el-col>
    </el-row>
    <!-- <el-col :span="16">
      <div>{{this.rowdata.event_msg}}</div>
    </el-col> -->
...
<!--
  ...
  <div class="attack-content-top clearfloat" v-show="visible == true">
    <div class="" style="position:absolute;top:0px; z-index:99;width:100%;height:95%">
        <canvas id="canvas" width="1500" height="500px"></canvas>
    </div>
...
export default {
  ...
  methods: {
    ...
    getSingleRes() {
      ...
      // param.dst_port = '8085'
      param.src_ip = this.rowData.event_src_ip;
      param.src_port = this.rowData.event_src_port;
      param.dst_ip = this.rowData.event_dest_ip;
      param.dst_port = this.rowData.event_dest_port;
      //源坐标
      param.srcx = 100;
      // param.srcy=150;
      //目标坐标
      ...
      param.starty = 50;
      // var vm = this;
      this.commonAjax.req("/ssa/netJtopo/getSingleResult.do", param, this).then(result => {
        //console.log(data);
    ...
    getRes() {
      ...
      param.starty = 50;
      var vm = this;
      this.commonAjax.req("/ssa/netJtopo/getResult.do", param, this).then(result => {
        var nodeList = {};
        var showIp = '';
