...
<div>
  ...
  <el-dialog title="流程轨迹" :visible.sync="dialogVisible" width="85%">
    <img width="70%" :src="processTrace" alt="流程轨迹图">
...
export default {
  ...
  data() {
    return {
      ...
      detailMap:{
        evaluationTask:"evaluationOrganDetail",
        disposalOpinionTask:"disposalOpinionDetail",
        disposalApprovalTask:"disposalApprovalDetail",
        reportCheckTask:"reportCheckDetail",
        fileTask:"fileDetail"
      }
    };
  },
  created:  function() {
    ...
    this.utils.req("/ssa/evaluationOrgan/listHiTask.do", {
      ...
      this.hiTasks.push({
        name: "任务检查详单",
        taskDefinitionKey: "evaluationTask",
        processInstanceId:processInstanceId,
        id: this.id,
        endTime:params.evaluation_time,
