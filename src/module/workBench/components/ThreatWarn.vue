...
<div class="el-panel-white">
  <div class="el-panel-white-heading">
    <h3 class="el-panel-white-title">威胁预警</h3>
  ...
  <div class="el-panel-white-body">
    <div class="work_cont postion_r" style="height:125px">
      ...
      <div style="height:120px" class="work_box" id="threatWarnMap"></div>
    </div>
  </div>
</div>
</template>
...
export default {
  ...
  methods: {
    ...
    async loadMapChart() {
      ...
      var myChart = echarts.init(document.getElementById("threatWarnMap"));
