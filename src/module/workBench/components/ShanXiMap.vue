...
<div class="el-panel-white">
  <div class="el-panel-white-heading">
    <h3 class="el-panel-white-title">任务累计</h3></div>
  <el-select v-model="optionValue" filterable style="width:90px;padding-left:15px!important;padding-left:10px!important" @change="changeProcess">
  ...
  <div class="el-panel-white-body">
    ...
    <div class="echartmapbox" id="taiyuanMap"></div>
  </div>
</div>
</template>
...
export default {
  ...
  methods: {
    ...
    async getWarnMgmtProcess() {
      ...
      params.isMap = "true";
      var data = await this.utils.req("/ssa/workBench/getTodoTasksByType.do", params, this);
      var data1 = await this.utils.req("/ssa/workBench/getHiTasksByType.do", params, this);
      this.todoData = data;
      this.hiData = data1;
      this.loadMapChart();
    },
    ...
    async loadMapChart() {
      var myChart = echarts.init(document.getElementById('taiyuanMap'));　
      var geoCoordMap = {
