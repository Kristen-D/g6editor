...
export default {
  ...
  methods: {
    downloadFile() {
      var fileUrl = "/ssa/processMgmt/downloadAttachment.do?bussiness_id=" + this.params.taskId + "&bussiness_type=" + "alarmMgmtJsProcess_pAudit1Task";
  ...
  created: async function() {
    ...
    var attachment = await this.common.req("/ssa/alarmManagerJs/getAttachment.do", {
      bussiness_type: "alarmMgmtJsProcess_pAudit1Task",
    ...
    this.common.req("/ssa/processMgmt/getHiVarsByTaskId.do", {
      ...
      vm.detail.remark = data[0].textValue;
