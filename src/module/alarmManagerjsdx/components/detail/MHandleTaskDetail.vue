...
export default {
  ...
  methods: {
    downloadFile() {
      var fileUrl = "/ssa/processMgmt/downloadAttachment.do?bussiness_id=" + this.params.taskId + "&bussiness_type=" + "alarmMgmtJsProcess_mHandleTask";
  ...
  created: async function() {
    ...
    var attachment = await this.common.req("/ssa/alarmManagerJs/getAttachment.do", {
      bussiness_type: "alarmMgmtJsProcess_mHandleTask",
