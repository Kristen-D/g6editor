<template>
  <div class="shine">
    ...
    <div class="el-panel-white-body">
      <el-row :gutter="20">
          <div class="echartsbox7" id="flowDayRadarA"></div>
        </el-row>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      params:{dateRange:'week',days:'',datetypeRange:'collect_date',},
      radiobutton: 2,
    }
  },
  methods: {
    ...
    async loadMapChart(){
      var data = await this.common.req("/ssa/blackURL/UrlCategory.do", this.params);
