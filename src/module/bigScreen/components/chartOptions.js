    ...
    label: {
      normal: {
        ...
        formatter: function (d) {
          return access.series[0].data[d.dataIndex]
        }
      }
    },
    tooltip: {
...
const colorList = [
  'rgba(12,145,168,0.8)', 'rgba(23,96,160,0.6)',
  'rgba(12,145,168,0.8)', 'rgba(23,96,160,0.6)',
  'rgba(12,145,168,0.8)', 'rgba(23,96,160,0.6)'
];
const radar = {
...
const attack = {
  color: ['rgba(206,74,36,.7)', 'rgba(206,125,8,.7)', 'rgba(206,191,55,.7)'],
  tooltip: {
    trigger: 'axis',
  ...
  //   data: [{name: '高危', icon: 'circle'}, {name: '中危', icon: 'circle'}, {name: '低危', icon: 'circle'}]
  // },
  grid: {
    top: 0,
    left: 0,
  ...
  series: [
    {
      name: '',
      type: 'line',
      lineStyle: {normal: {color: '#0c91a8', width: 2}},
      smooth: true,
      //symbol:'image://images/echarts-line.png',
      symbolSize: 10,
      showSymbol: false,
      data: []
    },
...
const mapTop = {
  ...
  yAxis: {
    type: 'category',
    axisTick: {show: false},
    axisLine: {lineStyle: {color: '#4787a0'}},
    axisLabel: {textStyle: {color: '#b6b5ab'}},
    data: []
  },
  series: [{
    name: '访问区域排行',
...
const map3d = {
  ...
  globe: {
    top: -15,
    environment: 'none',
    baseTexture: '/static/images/map3d/Map-jpg.jpg',
    ...
    light: {
      ...
      ambientCubemap: {
        texture: '/static/images/map3d/data-1491896094618-H1DmP-5px.hdr',
        exposure: 1,
        diffuseIntensity: 3,
        specularIntensity: 1
      }
    ...
    viewControl: {
      autoRotate: true,
      zoomSensitivity: 0,//缩放操作的灵敏度，值越大越灵敏。默认为``设置为0后无法缩放。
      distance: 250, //默认视角距离主体的距离
      targetCoord: [101.4038,36.8207]
    }
  },
...
const geoCoordMap = {
  ...
  '印度尼西亚': [113.921327, -0.78927499],
  '香港': [113.543873, 22.198745],
  '中国香港': [113.543873, 22.198745]
};

export {
  access, radar, pictorial, attack, url, mapTop, mapBottom, map3d, geoCoordMap
}
