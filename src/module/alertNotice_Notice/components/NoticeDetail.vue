...
<div>
  <div v-if="this.tkey == 'noticeHandleInfoTask'  ">
    ...
    <el-row class="process-content" :gutter="20">
      ...
      <el-col :span="16">
        <div>{{noticeHandleInfoDetail.approval_number}}</div>
      </el-col>
    </el-row>
  </div>


  <div v-if="this.tkey == 'noticeFbTask'">
    <!--<el-row>
  ...
  <div v-if="this.tkey == 'noticeSpTask'">
    <el-row class="process-content" :gutter="20">
      <el-col :span="4">
        <div>审核意见：</div>
      </el-col>
  ...
  <div v-if="this.tkey == 'noticeTzTask'  ">
    ...
    <el-row class="process-content" :gutter="20" v-if="this.eventTzDetailparams.isPass==1 && eventTzDetail.attachment_filepath != null && eventTzDetail.attachment_filepath != ''">
      <el-col :span="4">
        <div  style="color:#4db3ff;cursor:pointer;">附件：</div>
      </el-col>
      <el-col :span="16">
        <a  style="color:#4db3ff;cursor:pointer;" @click="downloadFile(eventTzDetail.notice_code)" v-show="eventTzDetail.attachment_filepath != null ">{{eventTzDetail.attachment_filename}}</a>
      </el-col>
    </el-row>
    <el-row class="process-content" :gutter="20" v-if="this.eventTzDetailparams.isPass==1 && (eventTzDetail.attachment_filepath == null || eventTzDetail.attachment_filepath =='')">
      <el-col :span="4">
    ...
    <el-row class="process-content" :gutter="20" v-if="this.eventTzDetailparams.isPass==1">
      ...
      <el-col :span="16">
        <div>{{eventTzDetail.org_name}}</div>
      </el-col>
    </el-row>
    <el-row class="process-content" :gutter="20" v-if="this.eventTzDetailparams.isPass==1">
      <el-col :span="4">
    ...
    <el-row class="process-content" :gutter="20"  v-if="this.eventTzDetailparams.isPass==1">
      ...
      <el-col :span="16">
        <div>{{eventTzDetail.approval_number}}</div>
      </el-col>
    </el-row>
  ...
  <div v-if="this.tkey == 'noticeJsTask'">
    <el-row class="process-content" :gutter="20">
      <el-col :span="4">
        <div>通知标题:</div>
      </el-col>
  ...
  <div v-if="this.tkey == 'noticeQsTask'" class="aa" >
    <el-row  :gutter="20">
      <el-col :span="8">
        <div>签收结果(红色未签收):</div>
      </el-col>
  ...
  <div v-if="this.tkey == 'noticeFkTask'" class="aa">
    <!-- <el-row class="process-content" :gutter="20">
      <el-col :span="4">
        <div>反馈结果:</div>
      </el-col>
...
export default {
  ...
  methods: {
    beforeUpload(file){
      ...
      this.uploadParams.bussiness_type = "NOTICE";
  ...
  downloadFile1() {
      var fileUrl = "/ssa/processMgmt/downloadAttachment.do?bussiness_id=" + this.params.notice_code + "&bussiness_type=" + "NOTICE";
      window.location.href = fileUrl;
    },
    downloadFile2(notice_code) {
      var fileUrl = "/ssa/alertNotice/downloadFile2.do?notice_code=" + notice_code+"&taskId="+this.eventFkDetail.taskId;
      window.location.href = fileUrl;
      },
