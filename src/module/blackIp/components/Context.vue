...
<section class="content">
 <div class="container-fluid">
     <el-breadcrumb separator-class="el-icon-arrow-right" class="top-breadcrumb">
         <el-breadcrumb-item >恶意IP</el-breadcrumb-item>
              ...
              <div class="" style="position: relative">
                          <el-form :model="params" :rules="rules" ref="params" label-width="80px" class="demo-form-inline elform">
                                  <div v-if="!advancedFlag" style="display:inline-block;">
                                        <div style="display:inline-block;">
                                            ...
                                            <el-form-item label=""  style="display:inline-block; " label-width="20px" >
                                                  ...
                                                  <el-input size="mini" v-if="params.attribute==='ip'" v-model="params.ip" placeholder="属性值" ></el-input>
                                  ...
                                  <div class="" v-if="advancedFlag" style="margin-top: 20px;">
                                    <div style="display:inline-block;">
                                        <el-form-item label="IP地址" style="display:inline-block;"  key='ip' >
                                          <el-input v-model="params.ip" placeholder="所有IP" size="mini"></el-input>
                                        </el-form-item>
                                        <!-- <el-form-item label="类型" style="display:inline-block;"class="test" key='category'>
                                            <el-select v-model="params.category" clearable placeholder="所有类型" size="mini"> <el-option
                                        ...
                                        <el-form-item label="来源" style="display:inline-block; "   key="source">
                                          <el-input v-model="params.source" placeholder="所有来源" size="mini"></el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="得分" style="display:inline-block; "  key="score">
                                          <el-input v-model="params.score" placeholder="所有得分" size="mini"></el-input>
                                        </el-form-item>
                            ...
                            <el-form-item v-if="advancedFlag" style="display:inline-block;margin-bottom:5px;">
                              ...
                              <el-button type="text" @click="showAdvanced" v-if="!advancedFlag" class="btn-search " id="advanced-search">高级搜索<i class="el-icon-caret-bottom m-l-6"></i></el-button>
...
<script>
import editTable from './BlackIpEditTable.vue'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      attributes: [{ value: 'ip', label: 'IP地址' },
                { value: 'type', label: '类型' },
  ...
  methods: {
    ...
    async initDataList() {
      let typ = await this.common.req('/ssa/blackIp/getTypeList.do', {}, this);
      this.categorys = typ;
