...
<div class="whitebackground Whitespace">
  <div class="top-title">黑白名单管理</div>
    ...
    <el-tab-pane label="黑名单" name="black">
      ...
      <div class="ordinary-search clearfloat" style="margin-top: 0px;">
        ...
        <el-form :inline="true" :model="queryForm" ref="queryForm" style="display: inline-block;">
          <el-form-item label="">
            <el-select v-model="mparams.list_type_id" clearable placeholder="名单类型">
              <el-option v-for="item in listTypeList" :label="item.text" :value="item.id">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="">
            <el-input placeholder="内容" v-model="mparams.list_value"> </el-input>
          </el-form-item>
        ...
        <div class="float-r button-toolbar">
          <el-button type="primary" size="small" @click="addRow(0)"><i class="icon-add m-r-8"></i>添加</el-button>
      ...
      <!-- <div class="float-r button-toolbar">
        ...
        <el-button type="primary" size="small" @click="delCheckedRows(0)"><i class="icon-delet m-r-8"></i>删除</el-button>
        <el-button type="primary" size="small" @click="downloadTemplate()" style="margin-left:10px;"> 模板下载</el-button>
        <el-upload style="display:inline-block;margin-left:10px;" action="/infoCenter_blackWhiteList/empBatchHandle.do?bw_type=0" :file-list="fileList" :before-upload="handleBeforeUpload" :accept="accept_type" :show-upload-list="false" :on-success="handleSuccessOnBlack">
          <el-button size="small" type="primary">批量导入</el-button>
        </el-upload>

      </div> -->
      <div>
        <blackEditTable :id="blackId"></blackEditTable>
      </div>
