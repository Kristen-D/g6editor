...
<div class="whitebackground Whitespace">
  <div class="top-title">接入网络链路</div>
      ...
      <el-form :model="params" ref="params" label-width="120px">
        <div v-if="!advancedFlag" style="display:inline-block;">
          <div style="display:inline-block;">
            <el-input v-model="queryForm.q_unit_name" placeholder="责任单位名称" ></el-input>
          </div>
          ...
          <div v-if="advancedFlag" style="margin-top:20px;">
            <el-form-item label="负责单位" style="display:inline-block;">
              <el-input placeholder="" v-model="queryForm.q_operation_name"></el-input>
            </el-form-item>
            <el-form-item label="运维单位" style="display:inline-block;">
              <el-input placeholder="" v-model="queryForm.q_unit_name"></el-input>
            </el-form-item>
            ...
            <el-form-item label="运营商" style="display:inline-block;">
              <el-input placeholder="" v-model="queryForm.q_operator"></el-input>
            </el-form-item>
            <el-form-item label="物理位置" style="display:inline-block;">
              <el-input placeholder="" v-model="queryForm.q_physical_access"></el-input>
            </el-form-item>
            <el-form-item label="安全负责人" style="display:inline-block;">
              <el-input placeholder="" v-model="queryForm.q_safety_charger"></el-input>
            </el-form-item>
            <el-form-item label="联系电话" style="display:inline-block;">
              <el-input placeholder="所有电话" v-model="queryForm.q_safety_charge_phone"></el-input>
            </el-form-item>
          </div>
        <!-- </transition> -->
  ...
  <el-tabs v-model="activeName">
    ...
    <el-tab-pane label="已完成" name="done">
      <div>
        <completedTable :id="doneId"></completedTable>
      </div>
    </el-tab-pane>
  ...
  <el-dialog title="导入" :visible.sync="exportDialogShow" width="30%" class="dialog-panel">
    <div class="dialog-import-content">
      ...
      <a href="/static/template/NetLinkAccessInfo.xlsx" class="dialog-downloadtext font-color">模版下载</a>

      <el-upload ref="upload" action="/ssa/netLinkAccess/batchImportNetLinkAccessInfo.do" :auto-upload="false" :multiple="false" :on-success="handleSuccess">
  ...
  data() {
    return {
      ...
      queryForm: {
        ...
        q_safety_charger: "",
        q_unit_type: "",
        q_safety_charge_phone: "",
      },
       delSelected: "/ssa/netLinkAccess/deleteCheckedRows.do",
