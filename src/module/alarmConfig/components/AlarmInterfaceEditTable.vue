...
<div>
  ...
  <el-table  v-loading="defConf.loading"   :data="defConf.tableData" style="width: 100%" @sort-change="handleSortChange"  @selection-change="handleSelectionChange">
    ...
    <el-table-column   sortable="'custom'"  prop="alarm_type"  label="告警类型"  align="center">
<template   scope="scope">
   ...
   <el-table-column   sortable="'custom'"  prop="alarm_grade"  label="风险级别"  align="center">
<template   scope="scope">
    <div>
  ...
  <el-table-column prop="typename"  label="告警方式"  align="center">
 </el-table-column>
  <el-table-column prop="send_object_userName"  label="告警对象" min-width="150" :show-overflow-tooltip="true" align="center">
 </el-table-column>

<el-table-column  prop="card_copy_object_userName"  label="抄送对象" min-width="150" align="center" :show-overflow-tooltip="true">
</el-table-column>
...
//methods end
   ...
   created :function() {
    ...
    multipleSelection:[],
    //默认ajax属性
    tableUrl:"/ssa/alarm_config/getDataList.do",
    params:{bw_type:"0"},//初始化设置黑白名单类型,黑名单为0，白名单为1
    saveUrl:"/ssa/alarm_config/saveData.do",
    delUrl:"/ssa/alarm_config/deleteData.do",
   };
