...
<div class="el-panel">
  ...
  <!-- <div class="el-panel-body echartmapbox4" style="position: relative;"> -->
    ...
    <!-- <div class="tit-map" style="text-align: center;">
      ...
      <div class="tit-label"><label>新增告警</label><span>{{statistics.newWarn.toLocaleString()}}</span></div>
    </div> -->
    <ul class="tip-map">
      <li>
        <label>累计发现</label>
...
export default {
  ...
  methods: {
    getInitData() {
      this.common.req('/ssa/pups/getPupStatisticsData.do', this.params, this).then((data) => {
