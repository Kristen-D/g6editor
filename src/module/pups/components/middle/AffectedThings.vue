...
<div class="el-panel">
  <div class="el-panel-heading">
    <h4 class="el-panel-title">{{pupaffected.title}} </h4>
  </div>
...
export default {
  ...
  methods: {
    getInitData() {
      this.common.req('/ssa/pups/getAffectedAssetsAndDepartments.do', this.pupaffected, this).then((data) => {
    ...
    loadMapChart(data) {
      ...
      // let myChart = echarts.init(document.getElementById(this.pupaffected.eid));
      this.option = {
        color: ['#ff7d27'],
        tooltip: {
          trigger: 'axis',
