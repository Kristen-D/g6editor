...
<el-form ref="formRule" :model="formRule"  :rules="rules" label-width="120px">
                ...
                <el-form-item label="规则分类：" prop="ruleType">
                    <el-select v-model="formRule.ruleType" placeholder="请选择分类">
                     ...
                     <!-- <el-cascader
                        ...
                        v-model="formRule.ruleTypeCascader"
        ...
        <el-form-item label="是否启用：">
            <el-radio-group v-model="formRule.status">
                <el-radio :label="1">是</el-radio>
                <el-radio :label="2">否</el-radio>
            </el-radio-group>
        </el-form-item>
        <!-- <el-form-item label="参与循环：">
            <el-radio-group v-model="formRule.cycleEvent">
                <el-radio :label="1">是</el-radio>
...
export default{
    ...
    methods:{
        ...
        handleRuleTypeChange:function(value){
            this.formRule.ruleType=value[value.length-1]
        },
        checkValidateForm() {
