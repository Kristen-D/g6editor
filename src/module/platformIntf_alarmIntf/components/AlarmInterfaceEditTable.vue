...
<template   scope="scope">
  ...
  <el-table-column prop="alarm_email_object"  label="邮件告警对象" min-width="150" align="center">
 </el-table-column>


 <el-table-column  prop="email_template_id"  label="邮件模版" min-width="150" align="center">
<template   scope="scope">
  <div>
    <span v-show="!scope.row.edit&&!scope.row.create" style="margin-left: 10px">{{ fmtemailTemplateList(scope.row.email_template_id) }}</span>
    <el-select v-model="scope.row.email_template_id" v-show="scope.row.edit||scope.row.create"  placeholder="请选择">
      <el-option
...
<el-table-column  prop="frequency"  label="发送频率" min-width="150" align="center">
</el-table-column>
