<template >
  ...
  <div class="echartbox2" id="flowDaypieB"></div>
</template>
   ...
   watch:{
    ...
    methods: {
      ...
      async loadMapChart(){
        ...
        var myChart = echarts.init(document.getElementById("flowDaypieB"));
        // var lenData = [];
        // var seriesData=[];
        ...
        var option  = {
			    color:["#1abc9c","#3498db","#22638e","#b5b5b5","#ecf0f1"],
			   title: {
					text: "25",
					subtext: '设备总数',
					x: 'center',
				...
				legend: {
					...
					bottom: '35%',
					data: [
							{name:'防火墙',icon:'circle'},
							{name:'中间件',icon:'circle'},
							{name:'交换机',icon:'circle'},
							{name:'路由器',icon:'circle'},
							{name:'服务器',icon:'circle'},
							],
					textStyle: {
							color: '#9ea3b4'
						     },
