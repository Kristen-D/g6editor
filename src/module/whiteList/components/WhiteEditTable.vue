  ...
  <div>
    ...
    <div>
      ...
      <div class="pagelocation">
        <el-pagination class="pagination" @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-size="defConf.pageSize" :current-page.sync="defConf.pageIndex" background layout="total,sizes,prev, pager, next, jumper" :total="defConf.total">
        </el-pagination>
      </div>
    </div>
        <el-dialog :visible.sync="exportVisible" width="450px">
      <div class="dialog-confirm">
        <p>确认<span style="color: #2500ae;">导出所有白名单，</span>以Excel格式存入本地?</p>
        <!-- <p>(不超过50000条)</p> -->
...
export default {
  ...
  methods: {
    ...
    handleEdit(i, row) {
      ...
      this.$router.push({ name: "whiteForm", params: params });
    ...
    exportReport() {
      ...
      var param = "bw_type=1&exportFileName=" + "白名单表&fieldName=" + fieldName + "&list_type_id="+this.idList[this.id] + "&list_value=" + this.id;
