...
//我收到的流程
import systemRcvProcess from './SystemRcvProcess.vue'
//我发布的流程
import systemPubProcess from './SystemPubProcess.vue'
// 我发布 + 我收到
...
export default {
  ...
  created: async function() {
    ...
    //   this.currentView = "unitRcvProcess";
    // }
    //if(this.utils.hasRole(this.roles,[4,5])){
      this.currentView = "systemProcess";
    //}
