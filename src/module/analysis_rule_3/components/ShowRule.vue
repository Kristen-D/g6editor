...
<el-form ref="formRule" :model="formRule" label-width="120px">
        ...
        <el-form-item label="是否启用：">
                <span v-if="formRule.stats==1">是</span>
                <span v-if="formRule.stats==2">否</span>
        </el-form-item>
        <el-form-item label="子规则：">
                <span v-if="formRule.subRule==1">是</span>
                <span v-if="formRule.subRule==0">否</span>
        </el-form-item>
        <template v-if="formRule.configTemplate==4">
            <el-row>
            ...
            <el-row v-for="(node,index) in formRule.ruleFlow">
                <el-col :span="11">
                    <el-form-item v-bind:label="'节点'+(index+1)+'：'">
                        <span>{{getRuleSubSystemName(node.rule)}}</span>
                    </el-form-item>
                </el-col>
            </el-row>
       </template>
       <div v-if="formRule.configTemplate!=4">
        <el-row>
        ...
        <template v-for="(inputEventRule,eventRuleIndex) in formRule.inputEventRules">
            <el-row >
                <el-col :span="11">
                    <el-form-item v-bind:label="'设备('+inputEventRule.identity+')类型：'">
                        <span>{{getDeviceTypeName(inputEventRule.configEvent)}}</span>
                    </el-form-item>
                </el-col>
            </el-row>
                ...
                <el-row>
                    <el-col :span="13">
                        <el-form-item label="分组条件：">
                               <span>{{getGroupAttrName(formRule.groupField)}}</span>
                        </el-form-item>
                    </el-col>
                </el-row>

                <el-form-item label="分组类型：">
                    <span v-if="formRule.groupType==1">累加(sum)</span>
                    <span v-if="formRule.groupType==2">计数(count)</span>
                </el-form-item>
                <el-row>
                    <el-col :span="5" v-if="formRule.groupType==1" >
                        <el-form-item>
                            <span>{{getAttrName(formRule.sumField)}}</span>
                        </el-form-item>
                    </el-col>
        ...
        <el-row v-for="(outputRule,index) in formRule.outputRules">
            <el-col :span="11">
                <el-form-item v-bind:label="'字段'+(index+1)+'：'">
                    ...
                    <span v-if="index>0">{{getOutputAttrName(outputRule.outputAttrName)}}</span>
                </el-form-item>
            </el-col>
            <el-col :span="4">
                <el-form-item label="字段命名为" label-width="90px">
                    <span v-if="index==0"></span>
                    <span v-if="index>0">{{getAttrName(outputRule.renameAttrName)}}</span>
                </el-form-item>
            </el-col>
            <el-col :span="4">
