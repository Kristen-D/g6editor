<template >
   ...
   <div class="el-panel-white">
     ...
     <div class="el-panel-white-body">
       <el-row :gutter="20">
             <div class="echarts_BoxB3" style="height:150px;!important" id="flowDayRadarA"></div>
      	 </el-row>
</div>
  ...
  computed:{
   ...
   data(){
    ...
    methods: {
      ...
      async loadMapChart(){
        var data = await this.commonAjax.req("/ssa/hitLibrary/getLineReSave.do", this.params);
