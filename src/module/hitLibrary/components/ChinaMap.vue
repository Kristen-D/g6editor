   ...
   data(){
    ...
    methods: {
      ...
      showIpDetail(src_ip_attribution){
        ...
        this.tableUrl="/ssa/hitLibrary/getChinaMapDetail.do";
        // this.ipShow=true;
      ...
      async loadMapChart(){
        ...
        var Geodata = await this.commonAjax.req("/ssa/hitLibrary/getGeoCoordMap.do", this.params);
        var myChart = echarts.init(document.getElementById("flowDayBarA"));
        var Chinadata = await this.commonAjax.req("/ssa/hitLibrary/getChinaMap.do", this.params);
