<template >
   ...
   <div class="el-panel-white">
    ...
    <div class="el-panel-white-body">
      <el-row :gutter="20">
   <div class="echarts_BoxB1" style="height:200px;" id="flowDayScatterA"></div>
   </el-row>
  </div>
   ...
   data(){
    ...
    methods: {
      ...
      showIpDetail(src_ip){
        ...
        this.tableUrl="/ssa/hitLibrary/getHighRiskIpDetail.do";
        // this.ipShow=true;
      ...
      async loadMapChart(){
        var data = await this.commonAjax.req("/ssa/hitLibrary/getHighRiskIp.do", this.params);
