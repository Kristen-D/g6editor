...
<div>
  <header>
    <a href="" class="logo">
      <img src="/static/images/screen_gd/sanxia.png" alt="logo">
      <span class="logo-text">中国三峡网络安全态势</span>
    </a>
  ...
  <div class="container-wrap">
    <el-row :gutter="24">
      <el-col :span="7">
        ...
        <alarm-table style="height: 230px;"></alarm-table>
      </el-col>
      <el-col :span="17">
  ...
  <el-dialog  title="事件详情"  :modal="false" v-model="publicShow" size="large" @close="onCloseIp()" top="15%" >
