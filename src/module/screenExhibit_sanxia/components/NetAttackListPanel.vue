<template>
  <div class="net-attack-list-panel">
    ...
    <el-dialog :title="detailTitle" v-model="myShow2" size="large" @close="onCloseIp()"  top="15%" >
      <div class="float-r button-toolbar" style="margin-bottom:5px;">
    ...
    <el-dialog :title="detailTitle" v-model="myShow3" size="large" @close="onCloseIp()"  top="15%" >
      <div class="float-r button-toolbar" style="margin-bottom:5px;">
