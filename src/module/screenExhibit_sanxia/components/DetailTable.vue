...
<div class="">
  ...
  <el-table-column  prop="alarm_grade"  label="风险级别" inline-template min-width="80" show-overflow-tooltip="true"  align="center">
    <div>
      <span style="margin-left: 10px">{{ fmtalarmGradeList(row.alarm_grade) }}</span>
    </div>
  </el-table-column>
  ...
  <el-table-column  prop="externalIp_s"  label="事件类别" inline-template min-width="80" show-overflow-tooltip="true"  align="center">
    <div>
      <span style="margin-left: 10px">{{ fmtexternalIp_s(row.externalIp_s) }}</span>
    </div>
  </el-table-column>
