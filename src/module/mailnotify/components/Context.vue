...
<div class="top-title">发送规则</div>

    <div :class="[advancedFlag ? 'senior-search':'ordinary-search', clearfloat]">
        <el-form :model="params" ref="params" label-width="90px">
          <div class="" style="display:inline-block;">
            <el-form-item label="ID" style="display:inline-block;">
              <el-input v-model="params.id" placeholder="ID"></el-input>
            </el-form-item>
            <el-form-item label="收件人" style="display:inline-block;margin-left:20px;">
              <el-input v-model="params.recipients" placeholder="收件人"></el-input>
            </el-form-item>
            <el-form-item label="主题" style="display:inline-block;">
  ...
  <el-dialog title="导入" :visible.sync="exportDialogShow" width="30%">
    <div class="dialog-content">
      ...
      <a href="/static/template/供应商信息模版.xlsx" class="dialog-importEvent-label">供应商信息模版下载</a>
...
<script>
import editTable from './MailnotifyEditTable.vue'
export default {
  components: {
    editTable,
  },
  ...
  methods: {
    ...
    async delCheckedRows() {
      ...
      this.$confirm('此操作将删除选中条目, 是否继续?', '提示', {
        ...
        var result = await this.common.requestWithComplexContent("/ssa/email/batchedDetleMailnotify.do", JSON.stringify(rows), this);
