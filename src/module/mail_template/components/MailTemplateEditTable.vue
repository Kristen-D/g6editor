...
export default {
  ...
  methods: {
    ...
    handleEdit(i, row) {
      row.tableId = this.id;
      this.$router.push({name:'mailTemplateForm', params:row })
  ...
  created: function() {
    var defConf = {
      ...
      multipleSelection: [],
      //默认ajax属性
      tableUrl: "/ssa/email/queryMailTemplateList.do",
      params: {},
      saveUrl: "/ssa/email/addOrModifyMailTemplate.do",
      delUrl: "/ssa/email/batchedDetleMailTemplate.do",
    };
