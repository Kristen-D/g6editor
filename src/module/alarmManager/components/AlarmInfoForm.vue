  ...
  methods: {
    ...
    async spTaskSubmit(formName) {
      ...
      this.$refs[formName].validate(async(valid) => {
        if (valid) {
          ...
          var msg = await this.common.req("/ssa/alarmManager/completespTask.do", params, this);
          this.$message({
            type: "success",
            message: msg
          });
    ...
    async cltaskSubmit() {
      this.$refs["clInfoTaskForm"].validate(async(valid) => {
        ...
        params.alarmIds = this.$route.params.alarmIds;
          var msg = await this.common.req("/ssa/alarmManager/completeclTask.do",params, this);
