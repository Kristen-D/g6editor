    ...
    textStyle:{
      color:'#ffffff'
							...
							radar: {
								...
								center: ['50%', '60%'],
								indicator: [
								   { name: '192.168.32.11', max: 3000},
								   { name: '192.168.32.12', max: 3000},
								   { name: '192.168.32.13', max: 3000},
								   { name: '192.168.32.14', max: 3000},
								   { name: '192.168.32.15', max: 3000},
								   { name: '192.168.32.16', max: 3000}
								],
								name: {
								textStyle: {
									color:'#9ea3b4'
								...
								data : [
									{
									 ...
									 {
										value : [2000, 1400, 2400, 2500, 2300, 2100],
										name : '异常',
										areaStyle: {
											normal: {
