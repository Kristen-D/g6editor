      ...
      async loadMapChart(){
        ...
        title : {
            ...
            xAxis : [
              ...
              {
                type : 'category',
                data: ['192.168.2.3', '192.168.2.4', '192.168.2.5', '192.168.2.6'],
                scale:true,
                axisLabel : {
                  formatter: '{value}',
                  show:true,
            ...
            series : [
              {
                name:'登录',
                type:'scatter',
                data: [['192.168.2.6', 6], ['192.168.2.4',7],
                 ['192.168.2.5', 8], ['192.168.2.3', 8],
                ['192.168.2.3', 10],['192.168.2.3', 6],
                 ['192.168.2.4',7], ['192.168.2.5', 8],
                  ['192.168.2.3', 8], ['192.168.2.6', 10],
                 ['192.168.2.6', 10],['192.168.2.5', 6],
                  ['192.168.2.4',7], ['192.168.2.5', 8],
                   ['192.168.2.3', 8], ['192.168.2.3', 10],
              ],
              ...
              },
              {
                name:'登出',
                type:'scatter',
                data:[['192.168.2.3', 7], ['192.168.2.6',8],
                 ['192.168.2.5', 8], ['192.168.2.3',9],
                ['192.168.2.5', 10],['192.168.2.4', 10],
                 ['192.168.2.4',7], ['192.168.2.5', 6],
                  ['192.168.2.3',9], ['192.168.2.6', 10],
                  ['192.168.2.4', 8], ['192.168.2.6', 10],
                 ['192.168.2.3', 10],['192.168.2.5', 6],
                  ['192.168.2.5',7], ['192.168.2.5', 8],
              ],
