...
<div class="">
  <el-dialog :title="drillData.title" :visible.sync="drillData.dialogTableVisible" width="85%" class="dialog-panel">
    ...
    <el-table :data="drillData.tableData" style="margin-top:20px;">
      ...
      <el-table-column prop="sender" label="发送者" align="center"  show-overflow-tooltip></el-table-column>
      <el-table-column prop="receiver" label="接收者" align="center" show-overflow-tooltip></el-table-column>
      <el-table-column prop="occ_time" label="发送时间" align="center" show-overflow-tooltip></el-table-column>
      <!-- <el-table-column prop="cvenumber" label="CVE编号" align="center"></el-table-column> -->
      <el-table-column prop="src_ip" label="源IP" align="center"></el-table-column>
      <el-table-column prop="src_port" label="源端口" align="center" ></el-table-column>
      <el-table-column prop="dst_ip" label="目标IP" align="center">
      </el-table-column>
      <el-table-column prop="dst_port" label="目标端口" align="center" >
      </el-table-column>
      <!-- <el-table-column prop="src_mac" label="源主机MAC" align="center" sortable>
      </el-table-column>
      <el-table-column prop="dst_mac" label="接收主机MAC" align="center" sortable>
      </el-table-column>
      <el-table-column prop="request_bytes" label="请求字节数" align="center" sortable>
      </el-table-column>
      <el-table-column prop="response_bytes" label="响应字节数" align="center" sortable>
      </el-table-column> -->
      <div slot="empty" >
