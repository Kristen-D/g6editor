...
<div>
  ...
  <el-table  v-loading="defConf.loading"  :border="true" :data="defConf.tableData" style="width: 100%" @sort-change="handleSortChange"  @selection-change="handleSelectionChange">
    ...
    <el-table-column sortable="'custom'" prop="hit_time"  label="撞库时间" min-width="90" show-overflow-tooltip  align="center">
    </el-table-column>
...
<template   scope="scope">
    ...
    <el-table-column  sortable="'custom'" prop="inform_time"  label="通知用户时间" min-width="90" show-overflow-tooltip  align="center">
    </el-table-column>
...
<template   scope="scope">
    ...
    <el-table-column sortable="'custom'" prop="pwd_change_time"  label="密码更改时间" show-overflow-tooltip min-width="90"  align="center">
    </el-table-column> -->
    <el-table-column sortable="'custom'" prop="login_type"  label="登录类型" min-width="80"  align="center">
    </el-table-column>
    <!-- <el-table-column sortable="'custom'" prop="insert_time"  label="入库时间" min-width="80"  align="center">
    </el-table-column> -->
</el-table>
</div>
...
//methods end
   ...
   created :function() {
    ...
    multipleSelection:[],
    //默认ajax属性
    tableUrl:"/ssa/ebankpoc/getHighAccountDataList.do",
