...
<div class="">
      <div class="whitebackground Whitespace">
        ...
        <div class="top-title" v-if="!this.$route.params.assetCode">新增资源池</div>
        ...
        <el-form :model="resourcePoolInfoForm" :rules="rules" ref="resourcePoolInfoForm" label-width="100px" class="form-contral">
          ...
          <el-form-item label="名称" prop="name" required>
            <el-input v-model="resourcePoolInfoForm.name" style="width:300px;"></el-input>
          </el-form-item>
          ...
          <el-form-item label="类型" prop="type" required>
            <el-select v-model="resourcePoolInfoForm.type" placeholder="请选择资源池" style="width:300px;">
              <el-option :label="d.productName" :value="d.type" v-for="d in type"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-input v-model="resourcePoolInfoForm.company" style="width:300px;"></el-input>
          </el-form-item>
          ...
          <el-input v-model="resourcePoolInfoForm.productModel" style="width:300px;"></el-input>
          </el-form-item>
          <el-form-item label="软件版本" prop="version" >
          <el-input v-model="resourcePoolInfoForm.version" style="width:300px;"></el-input>
          </el-form-item>
          ...
          <el-form-item label="管理IP" prop="ip" >
            <el-input v-model="resourcePoolInfoForm.ip" style="width:300px;"></el-input>
          </el-form-item>
          ...
          <el-input v-model="resourcePoolInfoForm.account" style="width:300px;"></el-input>
          </el-form-item>
          <el-form-item label="密码" prop="password" >
            <el-input v-model="resourcePoolInfoForm.password" style="width:300px;"></el-input>
          </el-form-item>
          <el-form-item label="云平台管理URL" prop="url" >
            <el-input v-model="resourcePoolInfoForm.url" style="width:300px;"></el-input>
          </el-form-item>
          <el-form-item label="云平台accessKey" prop="accessKey" >
            <el-input v-model="resourcePoolInfoForm.accessKey" style="width:300px;"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            ...
            <el-button type="primary" class="button-p-3" @click="submitForm('resourcePoolInfoForm')">提交</el-button>
            <!--<el-button type="gray" class="button-p-3" @click="resetForm('assetInfoForm')">取消</el-button>-->
            <el-button type="gray" class="button-p-3" @click="resetForm('resourcePoolInfoForm')">取消</el-button>
...
export default {
  ...
  computed: {
    ipRange: function() {
      ...
      let orgId = this.resourcePoolInfoForm.assetOrg[this.resourcePoolInfoForm.assetOrg.length-1];
      let ip = '';
      if(orgId){
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async(valid) => {
        if (valid) {
          ...
          this.resourcePoolInfoForm.assetOrg = this.resourcePoolInfoForm.assetOrg[this.resourcePoolInfoForm.assetOrg.length-1]
          let data = await this.common.reqBackState('/ssa/assetMgmt/addOrModifyAssetInfo.do', this.resourcePoolInfoForm, this);
          if (data.state) {
  ...
  created: async function() {
    ...
    if (this.$route.params.handle=='update') {
      ...
      this.resourcePoolInfoForm = this.$route.params;

      // let assetInfo = JSON.stringify(this.$route.params);
      let resourcePoolInfo = JSON.stringify(this.$route.params);
      sessionStorage.resourcePoolInfoForm = resourcePoolInfo;
    // }else if (sessionStorage.assetInfoForm) {
      }else if (sessionStorage.resourcePoolInfoForm) {
      this.resourcePoolInfoForm = JSON.parse(sessionStorage.resourcePoolInfoForm);
      // this.$route.params.assetId = this.assetInfoForm.assetId;
      this.$route.params.assetId = this.resourcePoolInfoForm.assetId;
    }
