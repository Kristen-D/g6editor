        ...
        <el-form :model="params" ref="params" label-width="80px">
          <div class="" style="display:inline-block;">
            <el-form-item label="资源池类型" style="display:inline-block;">
              <!--<el-input v-model="params.assetName" placeholder="资源池类型"></el-input>-->
              <el-input v-model="params.type" placeholder="资源池类型"></el-input>
            </el-form-item>
            <el-form-item label="名称" style="display:inline-block;">
              <!--<el-input v-model="params.assetName" placeholder="名称"></el-input>-->
              <el-input v-model="params.name" placeholder="名称"></el-input>
            </el-form-item>
            <el-form-item label="IP地址" style="display:inline-block;margin-left:20px;">
              <!--<el-input v-model="params.assetCode" placeholder="IP地址"></el-input>-->
...
import editTable from './resourcePoolEditTable.vue'
export default {
  components: {
    editTable,
  },
