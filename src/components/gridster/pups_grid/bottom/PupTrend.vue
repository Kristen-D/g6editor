...
export default {
  ...
  methods: {
    async getInitData() {
      let dataUrl = this.configuration.dataUrl;
      let [lineData1, lineData2, lineData3, lineData4, lineData5] = await Promise.all([
        this.common.req(dataUrl, this.configuration.params[0], this),
        this.common.req(dataUrl, this.configuration.params[1], this),
        this.common.req(dataUrl, this.configuration.params[2], this),
        this.common.req(dataUrl, this.configuration.params[3], this),
        this.common.req(dataUrl, this.configuration.params[4], this)
      ]);
