...
// xAxis.data, legend.data, series
const keyAssetAttacked = {
...
// legend.data, yAxis.data, series
const keyInstAttacked = {
  // backgroundColor:'#091323',
  color: ['#f53c61', '#2196f3', '#50fca8'],
  animation: false,
  tooltip: {
...
// series[0].data, series[1].data, yAxis.data
const threatLevel = {
