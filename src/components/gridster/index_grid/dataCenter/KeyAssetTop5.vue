<template >
   <!-- <div id="mymap" style="height:358px;"></div> -->
    ...
    <el-col  :span="24">
      <!-- <div class="el-panel-subtitle">数据中心</div> -->
   <el-row :gutter="16">
     <el-col  :span="8">
     ...
     <el-col  :span="8">
         ...
         <el-table :data="tableDataBehavior"   class="white-table table_item"  max-height="260"  :row-class-name="tableRowClassName">
           <el-table-column :show-overflow-tooltip="true" prop="name"  min-width="120" label="行为类型" >
           </el-table-column>
           <el-table-column :show-overflow-tooltip="true" prop="count"  min-width="60" label="数量"  >
           </el-table-column>
         </el-table>
      ...
      <el-col  :span="8">
        ...
        <el-table :data="tableDataDevice"  style="width: 100%;"  class="white-table table_item"  max-height="250" :row-class-name="tableRowClassName">
				<el-table-column prop="name" :show-overflow-tooltip="true" min-width="120" label="设备"></el-table-column>
				<el-table-column prop="count" min-width="60"  label="数据量"></el-table-column>
        ...
        <!-- <el-table :data="tableDataDevice"  border class="white-table table_item"  max-height="250"  :row-class-name="tableRowClassName">
          </el-table-column>
