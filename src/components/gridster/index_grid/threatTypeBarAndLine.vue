<template >
  ...
  <div class="el-panel mygrid-def">
    <div class="el-panel-heading">
      <h3 class="el-panel-title">威胁类型趋势</h3>
    ...
    <div class="el-panel-body">
      ...
      <!-- <el-row> -->
        <div style="height:260px">
      <e-charts @chartclick="chartClick" :options="option" style="width:100%"  class="echartbox2" auto-resize></e-charts>
    </div>
      <!-- </el-row> -->
      </el-col>
      </el-row>

       <!-- <div id="attackLine1" class="echartbox2" ></div> -->
...
export default {
  ...
  methods: {
    ...
    //   var myChart2 = echarts.init(document.getElementById('ThreatypePie2'));
    //   var seriesData2 = [];
    ...
    loadMapChartEventThreatType(data) {
      ...
      // var myChart = echarts.init(document.getElementById("attackLine1"));
      var lenData = [];
      var seriesData = [];
      var xAxis = [];
    ...
    loadMapChart() {
      this.commonAjax.req("/ssa/situationAnaly/getLineByEventThreatTypeWx.do", this.params).then(data => {
        this.loadMapChartEventThreatType(data);
      });
      this.commonAjax.req("/ssa/situationAnaly/getPieByRiskType_wx.do", this.params).then(data=>{
