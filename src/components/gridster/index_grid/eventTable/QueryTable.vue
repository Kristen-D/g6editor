<template>
<div>
  <el-table v-loading="defConf.loading" :data="defConf.tableData" @sort-change="handleSortChange">
...
<!-- </br> -->
 <div class="pagelocation" style="margin-right: 0;">
    <el-pagination @current-change="handleCurrentChange"  :page-size="defConf.pageSize"
     :current-page="defConf.pageIndex"   layout="total, prev, pager, next, jumper" :total="defConf.total"> </el-pagination>
</div>
