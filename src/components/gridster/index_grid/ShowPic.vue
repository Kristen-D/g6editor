...
<div class="whitebackground Whitespace">
  ...
  <div class="attack-sel clearfloat">
    <el-row>
        <el-col :span="25">
          <span class="demonstration">{{this.data.event_msg}}</span>
        </el-col>
    </el-row>
    <!-- <el-col :span="16">
      <div>{{this.data.event_msg}}</div>
    </el-col> -->
...
export default {
  ...
  methods: {
    ...
    getSingleRes() {
      ...
      // param.dst_port = '8085'
      param.src_ip = this.data.event_src_ip;
      param.src_port = this.data.event_src_port;
      param.dst_ip = this.data.event_dest_ip;
      param.dst_port = this.data.event_dest_port;
      //源坐标
      param.srcx = 100;
      // param.srcy=150;
      //目标坐标
