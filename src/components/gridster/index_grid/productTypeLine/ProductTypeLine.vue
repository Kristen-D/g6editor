<template>
  ...
  <div class="el-panel mygrid-def">
    <div class="el-panel-heading">
      <h3 class="el-panel-title">攻击视图</h3>
      ...
      <el-row>
        ...
        <el-col :span="14">
          <el-table :data="EventThreatTypeTop5" style="width: 100%" class="nobordertable">
            ...
            <el-table-column prop="count" label="攻击者IP量" show-overflow-tooltip align="center"></el-table-column>
            <el-table-column prop="ipCount" label="攻击目标IP数量" show-overflow-tooltip align="center"></el-table-column>
            <el-table-column prop="productCount" label="攻击数量" show-overflow-tooltip align="center"></el-table-column>
          </el-table>
        </el-col>
      </el-row>
    </div>
...
export default {
  ...
  methods: {
    ...
    initData() {
      this.commonAjax.req("/ssa/situationAnaly/getCountEventThreatTypeTop5.do", this.params).then(data => {
